...
export default function Teachers() {
  ...
  const handleClose = () => {
    ...
    setEditMode(false)
    setEditId(null)
    setFormData({ name: '', abbreviation: '', email: '', phone: '', recruitment: '', department_id: '' })
  }
  ...
  const filteredTeachers = teachers.filter((teacher) => {
    ...
    return (
      ...
      teacher.recruitment.toLowerCase().includes(query) ||
  ...
  const columns = [
    ...
    { field: 'recruitment', headerName: 'Recruitment', width: 120 },
    { 
      field: 'department_id', 
  ...
  return (
    <div>
      ...
      <Box sx={{ mb: 2 }}>
        <TextField
          fullWidth
          placeholder="Search by name, abbreviation, email, phone, recruitment, or department..."
          value={searchQuery}
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) => setFormData({ ...formData, recruitment: e.target.value })}
            required
          >
